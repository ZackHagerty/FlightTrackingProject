...
class GUI():
    ...
    def plotPlanes(self, root):
        ...
        for i in range(len(self.AAL_X_Array)):
            ...
            AAL = self.canvas.create_image(self.AAL_X_Array[i], self.AAL_Y_Array[i], image=plane3done, tags =('plane'))
        ...
        for i in range(len(self.AAY_X_Array)):
            ...
            plane3done = ImageTk.PhotoImage(plane3)
            AAY = self.canvas.create_image(self.AAY_X_Array[i], self.AAY_Y_Array[i], image=plane3done, tags =('plane'))
        ...
        for i in range(len(self.ACA_X_Array)):
            ...
            plane3done = ImageTk.PhotoImage(plane3)
            ACA = self.canvas.create_image(self.ACA_X_Array[i], self.ACA_Y_Array[i], image=plane3done, tags =('plane'))
        ...
        for i in range(len(self.AFR_X_Array)):
            ...
            plane3done = ImageTk.PhotoImage(plane3)
            AFR = self.canvas.create_image(self.AFR_X_Array[i], self.AFR_Y_Array[i], image=plane3done, tags =('plane'))
        ...
        for i in range(len(self.AMX_X_Array)):
            ...
            plane3done = ImageTk.PhotoImage(plane3)
            AMX = self.canvas.create_image(self.AMX_X_Array[i], self.AMX_Y_Array[i], image=plane3done, tags =('plane'))
        ...
        for i in range(len(self.ASA_X_Array)):
            ...
            plane3done = ImageTk.PhotoImage(plane3)
            ASA = self.canvas.create_image(self.ASA_X_Array[i], self.ASA_Y_Array[i], image=plane3done, tags =('plane'))
        ...
        for i in range(len(self.DAL_X_Array)):
            ...
            plane3done = ImageTk.PhotoImage(plane3)
            DAL = self.canvas.create_image(self.DAL_X_Array[i], self.DAL_Y_Array[i], image=plane3done, tags =('plane'))
        ...
        for i in range(len(self.FFT_X_Array)):
            ...
            plane3done = ImageTk.PhotoImage(plane3)
            FFT = self.canvas.create_image(self.FFT_X_Array[i], self.FFT_Y_Array[i], image=plane3done, tags =('plane'))
        ...
        for i in range(len(self.JBU_X_Array)):
            ...
            plane3done = ImageTk.PhotoImage(plane3)
            JBU = self.canvas.create_image(self.JBU_X_Array[i], self.JBU_Y_Array[i], image=plane3done, tags =('plane'))
        ...
        for i in range(len(self.NKS_X_Array)):
            ...
            plane3done = ImageTk.PhotoImage(plane3)
            NKS = self.canvas.create_image(self.NKS_X_Array[i], self.NKS_Y_Array[i], image=plane3done, tags =('plane'))
        ...
        for i in range(len(self.SWA_X_Array)):
            ...
            plane3done = ImageTk.PhotoImage(plane3)
            SWA = self.canvas.create_image(self.SWA_X_Array[i], self.SWA_Y_Array[i], image=plane3done, tags =('plane'))
        ...
        for i in range(len(self.UAL_X_Array)):
            ...
            plane3done = ImageTk.PhotoImage(plane3)
            UAL = self.canvas.create_image(self.UAL_X_Array[i], self.UAL_Y_Array[i], image=plane3done, tags =('plane'))
